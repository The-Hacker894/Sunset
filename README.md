...
Before trying to run Sunset you should type  `npm install --save discord.js moment opusscript ytdl-core request fs get-youtube-id youtube-info ffmpeg-binaries cheerio snekfetch querystring` and press enter/return
