  ...
  if (isStaffchannelcreate) {
	...
	var config = require("./config.json");
      ...
      var helpembed = new Discord.RichEmbed()
        ...
        if(helpcommand === `play`) return message.channel.send('please wait')
        if(helpcommand === `pause`) return message.channel.send('please wait')
        if(helpcommand === `queue`) return message.channel.send('please wait')
        if(helpcommand === `clear`) return message.channel.send('please wait')
        if(helpcommand === `skip`) return message.channel.send('please wait')
