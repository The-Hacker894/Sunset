...
var infosembed = new Discord.RichEmbed()
    ...
    .addField('Sunset Invite', '[Sunset Invite](https://hacker-hub.com/sunset/invite)', true)
    .addField('Sunset Lite Invite', '[Sunset Lite Invite](https://hacker-hub.com/sunset-lite/invite)', true)
    .addField('Website', '[Sunset Website](https://hacker-hub.com/sunset/)',true)
